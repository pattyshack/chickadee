...
func TestJltUintRightImmediate(t *testing.T) {
...
func TestJltUintLeftImmediate(t *testing.T) {
	src := ir.NewLocalReference("src")
	srcDef := &ir.Definition{
		Name: "src",
		Type: ir.Uint64,
...
func TestJltIntRightImmediate(t *testing.T) {
	src := ir.NewLocalReference("src")
	srcDef := &ir.Definition{
		Name: "src",
		Type: ir.Int64,
...
func TestJltIntLeftImmediate(t *testing.T) {
	src := ir.NewLocalReference("src")
	srcDef := &ir.Definition{
		Name: "src",
		Type: ir.Int64,
